...
object SparkEngine {
  def getSparkConf():SparkConf = {
    ...
    val sparkConf: SparkConf = new SparkConf()
      ...
      .set("enableSendEmailOnTaskFail", "false")
...
//      .set("spark.streaming.concurrentJobs" , "5")
  ...
  def getSparkSession(sparkConf:SparkConf):SparkSession = {
    ...
    val sparkSession: SparkSession = SparkSession.builder()
      ...
      .config("enableSendEmailOnTaskFail", "false")
      .config("spark.extraListeners", "com.cartravel.spark.SparkAppListener")//开启离线监控
      .enableHiveSupport() //开启支持hive SQL
      .getOrCreate()
